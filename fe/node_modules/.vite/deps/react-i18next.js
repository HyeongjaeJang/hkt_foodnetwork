...
var c = { parse: function(e2, t2) {
  ...
  return e2.replace(r, function(r2, s2) {
    ...
    var u2, f = "/" !== r2.charAt(1), h2 = r2.startsWith("<!--"), p2 = s2 + r2.length, d = e2.charAt(p2);
    if (h2) {
      var v = n(r2);
      return l < 0 ? (c2.push(v), c2) : ((u2 = o[l]).children.push(v), c2);
    }
    if (f && (l++, "tag" === (a2 = n(r2)).type && t2.components[a2.name] && (a2.type = "component", m = true), a2.voidElement || m || !d || "<" === d || a2.children.push({ type: "text", content: e2.slice(p2, e2.indexOf("<", p2)) }), 0 === l && c2.push(a2), (u2 = o[l - 1]) && u2.children.push(a2), o[l] = a2), (!f || a2.voidElement) && (l > -1 && (a2.voidElement || a2.name === r2.slice(2, -1)) && (l--, a2 = -1 === l ? c2 : o[l]), !m && "<" !== d && d)) {
      u2 = -1 === l ? c2 : o[l].children;
      var x = e2.indexOf("<", p2), g = e2.slice(p2, -1 === x ? void 0 : x);
...
function hasValidReactChildren(children) {
  if (Object.prototype.toString.call(children) !== "[object Array]")
    return false;
  return children.every((child) => fn(child));
}
...
function renderNodes(children, targetString, i18n, i18nOptions, combinedTOpts, shouldUnescape) {
  ...
  function getData(childs) {
    ...
    childrenArray.forEach((child) => {
      ...
      else if (typeof child === "object" && !fn(child))
  ...
  function pushTranslatedJSX(child, inner, mem, i2, isVoid) {
    if (child.dummy) {
      ...
      mem.push(...A.map([child], (c2) => {
        const props = {
          ...c2.props
        };
        delete props.i18nIsDynamicList;
        return wn.createElement(c2.type, _extends({}, props, {
          key: i2,
          ref: c2.ref
        }, isVoid ? {} : {
          children: inner
...
function Trans(_ref) {
  ...
  return useAsParent ? y(useAsParent, additionalProps, content) : content;
}
...
function withTranslation(ns) {
  ...
  return function Extend(WrappedComponent) {
    function I18nextWithTranslation(_ref) {
      ...
      return y(WrappedComponent, passDownProps);
    }
    I18nextWithTranslation.displayName = `withI18nextTranslation(${getDisplayName(WrappedComponent)})`;
    I18nextWithTranslation.WrappedComponent = WrappedComponent;
    const forwardRef = (props, ref) => y(I18nextWithTranslation, Object.assign({}, props, {
      forwardedRef: ref
    }));
    return options.withRef ? N(forwardRef) : I18nextWithTranslation;
  };
}
